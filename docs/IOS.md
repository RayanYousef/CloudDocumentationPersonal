...
- [**Prerequisites**](#prerequisites)
  ...
  - 🍎 [Apple Developer Program Setup](#2-apple-developer-program-setup)
    ...
    - 🔑 [Create Required Certificates and Provisioning Profiles](#create-required-certificates-and-provisioning-profiles)
      - 📜 [Apple Distribution Certificate](#21-apple-distribution-certificate)
      - 🔔 [APNS Certificate (for Push Notifications)](#22-apns-certificate-for-push-notifications)
      - 📱 [Provisioning Profile](#23-provisioning-profile)
...
| `APNS_P12_PASSWORD` | See SignCode guide | See [SignCode](./IOS_APNS_CODE_SIGNING.md) |
| `APPLE_DISTRIBUTION_P12_PASSWORD` | See SignCode guide | See [SignCode](./IOS_APNS_CODE_SIGNING.md) |
...
![Unity Player Settings - iOS Code Signing Configuration](./images/IOS_Identification.png)
...
You can find the complete iOS TestFlight workflow [here](../.github/workflows/ios-ipa-testflight.yml).
