...
> **📋 Prerequisites**: Ensure you've completed the [Prerequisites Setup](./prerequisites.md) first, including `VersioningSettings.json`, `WhatsNew` directory (located in `docs/CloudBuild/WhatsNew/`), and `CustomBuildProcessor.cs` script.
...
- **GitHub Actions Used**:
  - [Build Controller](../.github/workflows/main-controller.yml) - Orchestrates multiple build workflows
