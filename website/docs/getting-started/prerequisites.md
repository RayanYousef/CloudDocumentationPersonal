...
- [**📋 Common Project Setup**](#-common-project-setup)
  ...
  - [`Build Controller` Workflow](intro.md)
- **📝 Next Steps**
...
**📥 [Download Template](https://github.com/repository/blob/main/docs/CloudBuild/VersioningSettings.json)** - Use this as a starting point for your configuration
...
**📥 [Download Script](reference/scripts#custombuildprocessorcs)**
...
**Setup**:
1. Download the script from [here](reference/scripts#custombuildprocessorcs)
...
4. **Optional**: If you want runtime version display, also download and use [VersionInfo.cs](reference/scripts#versioninfocs) and [VersionText.cs](reference/scripts#versiontextcs)
